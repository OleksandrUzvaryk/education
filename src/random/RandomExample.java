...
public class RandomExample {
    public static void main(String[] args) {
        ...
        System.out.println("1st random " + Math.round(random1));
        System.out.println("2st random " + Math.round(random2));
        System.out.println("3st random " + Math.round(random3));
        System.out.println("4st random " + Math.round(random4));
        System.out.println("5st random " + Math.round(random5));
